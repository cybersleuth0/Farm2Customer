...
class ExplorePageNavigation extends StatelessWidget {
  final List<Map<String, dynamic>> _colorsAndbordercolor = [
    {
      "backcolor": Color(0x33f8a44c),
      "bordercolor": Color(0xfff8a44c),
    },
    {
      "backcolor": Color(0x33f7a593),
      "bordercolor": Color(0xfff7a593),
    },
    {
      "backcolor": Color(0x33d3b0e0),
      "bordercolor": Color(0xffd3b0e0),
    },
    {
      "backcolor": Color(0x33fde598),
      "bordercolor": Color(0xfffde598),
    },
    {
      "backcolor": Color(0x3353b175),
            ...
            GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: _colorsAndbordercolor[sameindexforcolor]
                            ["backcolor"],
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                          color: _colorsAndbordercolor[sameindexforcolor]
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: AssetImage(
                                    HomeScreen.itemcategories[index]
                                        ["categoryImg"],
                                  ),
                                ),
                              ),
